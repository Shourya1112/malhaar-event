  ...
  return (
    <div className="w-[5.75rem] h-screen fixed top-0 overflow-visible right-0 z-50 bg-off-white">
        <button className="group relative overflow-visible w-full h-[9.25rem] max-h-[9.25rem]">
            ...
            <div className="absolute z-20 animate-slide-in hidden group-hover:flex h-full w-[18rem] max-w-none top-0 right-[100%] ">
        ...
        <div className="w-full h-[calc(100%-9.25rem)] flex items-center justify-center">
